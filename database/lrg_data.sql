...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 24, 2021 at 01:50 PM
...
INSERT INTO `tbl_user` (`user_id`, `user_fname`, `user_name`, `priviledge`, `user_pass`, `user_email`, `user_date`, `last_login`, `expiry`, `user_ip`, `status`) VALUES
(1, 'jaskaran singh', 'singh', 'admin', 'L2WHxL5H71KsRd/JHMiO9U2qU0Yq+H+Prm/c6DdzEoILuTmK+NzG6wnMeO2YtnDGlT+BP74nFgw7XikkLaM2iw==', 'junealn54@gmail.com', '2021-03-24 03:36:25', 1616582185, '1922331600', '::1', 1);
...
ALTER TABLE `tbl_cast`
 ADD PRIMARY KEY (`cast_id`), ADD UNIQUE KEY `cast_name` (`cast_name`);
